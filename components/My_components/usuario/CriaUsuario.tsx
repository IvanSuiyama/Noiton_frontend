  ...
  const handleCreateUser = async () => {
    ...
    try {
      ...
      const response = await fetch(
        'http://192.168.247.119:4000/api/usuario/list', // Rota com IP celular
        // 'http://192.168.15.12:4000/api/usuario/list', // Rota com IP WiFi
        {
          method: 'GET',
        }
      );
      ...
      const createResponse = await fetch(
        'http://192.168.247.119:4000/api/usuario', // Rota com IP celular
        // 'http://192.168.15.12:4000/api/usuario', // Rota com IP WiFi
        {
          method: 'POST',
          headers: {
